...
<html>
<!-- Generated from index.xui by ghost, on Sat Sep 22 19:32:23 CST 2012 -->
<head>
      ...
      <td valign="top">
        <bttdojo:form id="index_form" errorPage="index.jsp">
          <table style="width:353px;height:265px;" id="index_form">
            ...
            <tr>
              <td>
                <bttdojo:a id="index_link01" text="TestingTreeFlow" flowId="TestingTreeFlow"/>
              </td>
            </tr>
            <tr>
              <td>
                <bttdojo:a id="index_link02" text="BP31707" flowId="BP31707Flow"/>
              </td>
            </tr>
          </table>
        </bttdojo:form>
